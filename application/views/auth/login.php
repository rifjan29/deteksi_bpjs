...
<div class="flex h-screen">
        <!-- Logo dan Teks -->
        <div class="w-1/3 bg-blue-900 text-white p-10 flex items-center pb-10">
            <div class="mb-24 text-center">
                <div class="h-16 w-16 bg-blue-700 rounded-full mx-auto flex items-center">
					<svg class="w-6 h-6 text-white dark:text-white mx-auto" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                ...
                <h2 class="text-lg font-bold mt-2">Sistem Verifikasi Internal</h2>
                <p class="text-sm">Sistem verifikasi internal untuk mengurangi pending claim</p>
            </div>
        </div>
        <!-- Formulir Login -->
